...
/**
 * @Route(
 *  "/{_locale}/dashboard/project/investments",
 *  name="dashboard_projects_investments_",
...
class InvestmentsController extends AbstractController
{
    ...
    public function index()
    {
        ...
        return $this->render('dashboard/project/investments/index.html.twig', [
    ...
    {
        return $this->render('dashboard/project/investments/view.html.twig', [
            'entity' => $investment,
        ]);
    }

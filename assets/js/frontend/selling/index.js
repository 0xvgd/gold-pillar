    ...
    methods: {
        ...
        fetchPostCodes(flag = false) {
            ...
            $.ajax({
                ...
                success: (resp) => {
                    ...
                    this.valuation = this.resultInfo.price;
                },
                complete: () => {
        ...
        gettingBookingValue(){
            ...
            if(!this.agent || !this.selectedDay || !this.selectedHour || this.valuation < 0 || !this.currentAddr)
                return false;
            values = {agent:this.agent.id,date:this.selectedDay.value,hour:this.selectedHour.val,
                price:this.valuation,addr:this.currentAddr.addr,city:this.currentAddr.city,county:this.currentAddr.county,code:this.queryPostCode};
            return values;
        },

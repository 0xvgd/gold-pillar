...
const pzgLoadingBG = document.getElementById(
  "payzone-loading-modal-background"
);
const siteRoot = GpApp.siteRoot;
...
export const sizePayzoneModal = (size) => {
  if (size == "threed") {
    pzgModal.style.width = "380px";
    pzgModal.style.height = "371px";
...
debugger;
  ...
  resultsData = data;
  debugger;
  resultsData["HashDigest"] = document.querySelector('input[data-field="hashDigest"]').value;
  resultsData["TransactionDateTime"] = document.querySelector('input[data-field="transactionDateTime"]').value;
  resultsData["CallbackURL"] =  document.querySelector('input[data-field="callbackURL"]').value; //cartData.get('CallbackURL');
  resultsData["OrderID"] =  document.querySelector('input[data-field="orderID"]').value; //cartData.get('OrderID');
  resultsData["OrderDescription"] = document.querySelector('input[data-field="orderDescription"]').value;
  resultsData["CurrencyCode"] =  document.querySelector('input[data-field="currencyCode"]').value;
  resultsData["Amount"] = document.querySelector('input[data-field="fullAmount"]').value;
  resultsData["AmountMinor"] = document.querySelector('input[data-field="amount"]').value; //cartData.get('Amount');

...
const datatableProfitPayment = $('#datatable-profit-payment')
const datatableReturnOfCapital = $('#datatable-return-capital')

const baseUrl = datatable.data('url')
const baseUrlProfitPayment = datatableProfitPayment.data('url')
const baseUrlReturnOfCapital = datatableReturnOfCapital.data('url')
...
datatableReturnOfCapital.dataTable({
    ajax: `${baseUrlReturnOfCapital}search_return_capital.json`,
    processing: true,
    serverSide: true,
    searching: false,
    columns: [
